...
class _MyOutpatientListPageState extends State<MyOutpatientListPage> {
                    ...
                    case ConnectionState.done:{
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          return
                          _specialistsCardInfoParam(sicks[index]['anamnesis'], sicks[index]['hospital'], sicks[index]['recordid']);
                        },
  ...
  Widget _specialistsCardInfoParam(String hospital,String anamnesis,String recordid) {
    return Container(
  ...
  Future<List> _getOutpatientList() async {
    
   QuerySnapshot snapshot= await DatabaseServices.getOutpatientList(FirebaseAuth.instance.currentUser.uid);
